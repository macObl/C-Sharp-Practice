...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <br />
    Student Number: &nbsp;&nbsp;&nbsp<asp:TextBox ID="number" runat="server" CssClass="input" Width="231px"></asp:TextBox>
    <asp:Label runat="server" ID="numberError" CssClass="error"></asp:Label>
    <br />
   <br />
    Student Name: &nbsp;&nbsp;&nbsp; &nbsp;&nbsp<asp:TextBox ID="name" runat="server" CssClass="input" Width="231px"></asp:TextBox>
    <br />
    <br />
    Grade: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="grade" runat="server" CssClass="input" Width="231px"></asp:TextBox>
    <br />
    <br />
    &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp<asp:Button ID="btnAddStudent" runat="server" Text="Save" OnClick="btnAddStudent_OnClick" CssClass="button" />
    <br />
    <br />
