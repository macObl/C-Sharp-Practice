    ...
    public partial class StudentRecordContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=(localdb)\\ProjectsV13;Database=StudentRecord;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AcademicRecord>(entity =>
            {
                entity.HasKey(e => new { e.StudentId, e.CourseCode })
                    .HasName("PK__Academic__3D0525991BE90091");
            ...
            modelBuilder.Entity<Course>(entity =>
            {
                entity.HasKey(e => e.Code)
                    .HasName("PK__Course__A25C5AA6ED043BFE");
            ...
            modelBuilder.Entity<Registration>(entity =>
            {
                entity.HasKey(e => new { e.CourseCourseId, e.StudentStudentNum })
                    .HasName("PK__Registra__92ECCCE9E1317083");
