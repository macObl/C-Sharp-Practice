...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    Course Number: &nbsp;&nbsp;&nbsp<asp:TextBox ID="courseNumber" runat="server" CssClass="input" Width="160px"></asp:TextBox>
    ...
    <br />
    <br />
    &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp<asp:Button ID="btnAddCourse" runat="server" Text="Submit Course Information" OnClick="btnAddCourse_OnClick" CssClass="button" />
    <br />
    <br />
